...
async def bot_info(message: types.Message):
    ...
    text += "Bu esa " + hlink('Github sahifasiga link\n', 'https://github.com/RahimovIlhom')
...
async def bot_info(message: types.Message):
    ...
    text += "Bu esa <a href='https://github.com/RahimovIlhom'>Github sahifasiga link</a>.\n"
...
async def bot_info(message: types.Message):
    ...
    text += "Bu esa [Github sahifasiga link](https://github.com/RahimovIlhom)\n"
